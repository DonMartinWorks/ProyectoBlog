                    ...
                    <div class="relative ml-3" x-data="{ open: false }">
                        ...
                        <div x-show="open" x-on:click.away="open = false"
                            ...
                            <a href="{{ route('admin.home') }}"
                                class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-300" role="menuitem"
                                tabindex="-1" id="user-menu-item-0">{{ __('Admin Dashboard') }}</a>
                            ...
                            <form method="POST" action="{{ route('logout') }}">@csrf
                                <a href="{{ route('logout') }}"
                                    ...
                                    class="block px-4 py-2 text-sm text-gray-700 hover:bg-rose-600 hover:text-white"
                                    role="menuitem" tabindex="-1" id="user-menu-item-2">{{ __('Log Out') }}</a>
                            </form>
                        </div>
                    </div>
                </div>
